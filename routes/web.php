...
Route::middleware(['auth', 'student.identity'])->group(function () {
    ...
    Route::prefix('master-data')->name('master.')->group(function () {
        ...
        Route::middleware('role:admin')->group(function () {
            ...
            Route::delete('/rak/{id}/hapus-foto', [RackLocationController::class, 'hapusFoto'])->name('rak.hapus-foto');
        });
    ...
    Route::prefix('inbound')->name('inbound.')->group(function () {
        ...
        Route::post('/unit-ajax', [InboundController::class, 'storeUnitAjax'])->name('unit.ajax');
        Route::get('/{id}', [InboundController::class, 'show'])->name('show');
        Route::middleware('role:admin')->post('/{id}/cancel', [InboundController::class, 'cancel'])->name('cancel');
    });
    ...
    Route::prefix('outbound')->name('outbound.')->group(function () {
        ...
        Route::middleware('role:admin')->post('/{id}/cancel', [OutboundController::class, 'cancel'])->name('cancel');
    });
    ...
    Route::middleware('role:admin')->prefix('practice-sessions')->name('practice-sessions.')->group(function () {
        Route::get('/', [PracticeSessionController::class, 'index'])->name('index');
        Route::post('/', [PracticeSessionController::class, 'store'])->name('store');
        Route::post('/{id}/close', [PracticeSessionController::class, 'close'])->name('close');
    });
