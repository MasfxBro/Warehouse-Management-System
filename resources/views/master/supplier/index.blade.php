...
<div class="bg-white rounded-lg shadow p-6">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('master.supplier.create') }}" class="bg-green-600 hover:bg-green-700 text-white px-6 py-2 rounded-lg">+ Tambah Supplier</a>
    </div>
        ...
        <tbody class="divide-y divide-gray-200">
            ...
            <tr class="hover:bg-gray-50">
                ...
                <td class="px-4 py-3 text-center">
                    <a href="{{ route('master.supplier.edit', $supplier->Supplier_ID) }}" class="text-blue-600 hover:text-blue-800 font-medium">Edit</a>
            ...
            @empty
            <tr><td colspan="4" class="text-center py-8 text-gray-500">Belum ada data supplier</td></tr>
            @endforelse
        </tbody>
    </table>
